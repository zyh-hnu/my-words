"""
知乎热门 RSS 源 - https://rsshub.app/zhihu/hot
"""
...
RSS_URL = "https://rsshub.app/zhihu/hot"
...
def fetch_news(limit: int = 20):
    ...
    if not entries:
        logger.warning("没有获取到知乎热门话题")
        return
    
    file_contents = []
    file_contents.append(f"# 知乎热门话题 - {news_utils.current_date_formatted()}\n\n")
